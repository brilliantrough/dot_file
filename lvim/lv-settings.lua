...
lvim.builtin.mason.install_root_dir = vim.fn.expand("~/.local/share/lvim/mason")
...
lvim.builtin.project.datapath = vim.fn.expand("~/.cache/lvim")
...
lvim.lazy.opts.lockfile = vim.fn.expand("~/.config/lvim/lazy-lock.json")
lvim.lazy.opts.performance.rtp.reset = false
lvim.lazy.opts.readme.root = vim.fn.expand("~/.local/share/lunarvim/lazy/readme")
lvim.lazy.opts.root = vim.fn.expand("~/.local/share/lunarvim/site/pack/lazy/opt")
...
lvim.lsp.nlsp_settings.setup.config_home = vim.fn.expand("~/.config/lvim/lsp-settings")
lvim.lsp.nlsp_settings.setup.loader = "json"
lvim.lsp.null_ls.setup.debug = false
lvim.lsp.templates_dir = vim.fn.expand("~/.local/share/lunarvim/site/after/ftplugin")
